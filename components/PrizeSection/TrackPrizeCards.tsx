...
import cardTrackContents from "./prizes";
    ...
    <>
      ...
      <div className="prizeContainer1">
          <div className="prizeContainer md:grid hidden grid-cols-1 sm:grid-cols-3 gap-3 lg:grid-cols-3 mb-10">
            {cardTrackContents.cardTrackContents.slice(0, 8).map((card: any, index: any) => (
              <Card
                show = {card.show}
                key={card.id || index}
                texts={card.texts}
...
export default TrackPrizeCards;
